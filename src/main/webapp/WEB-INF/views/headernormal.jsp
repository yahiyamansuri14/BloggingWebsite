	...
	<nav
		...
		<div class="collapse navbar-collapse" id="collapsibleNavBar">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a href="/user/showpostpage"
					class="nav-link"><b>Post</b></a></li>
				<li class="nav-item"><a href="/showaboutus" class="nav-link"><b>About
							Us</b></a></li>
				...
				<li class="nav-item"><a href="/showuserprofile"
					class="nav-link"><b>Profile</b></a></li>
			</ul>
		</div>
	</nav>
</body>
